<%-- 
    Document   : registry
    Created on : Mar 22, 2015, 8:45:41 PM
...
<html>
    <head>
        <title>Đơn giản là đăng ký thôi mà</title>
    ...
    <body>
        ...
        <br><br><pre>                               <font size="5" color="red">Đăng kí tài khoản mới</font></pre>
        <br><br>
        <form>
            <pre>                               Tên đăng nhập:                <input type="text" name="username" value="" /></pre>
            <pre>                               Mật khẩu:                          <input type="password" name="password1" value="" /></pre>
            <pre>                               Nhập lại mật khẩu mới:  <input type="password" name="password2" value="" /></pre>
            <pre>                               Mail:                                   <input type="text" name="mail" value="" /></pre>
            <pre>                               Địa chỉ:                               <input type="text" name="address" value="" /></pre>
            <pre>                               Điện thoại:                        <input type="text" name="phone" value="" /></pre>
            <pre>                               <input type="submit" value="Submit" name="Submit" class="btn btn-danger"/></pre>
        </form>
        <%
              ...
              if(b!=null)
              {
                  ...
                  if(!(password1.equals(password2)) || password1==null ||password1.trim()=="")
                  {
                      check=false;
                  ...
                  if(check)
                  {
                      String cmd="insert into account values(\'"+username+"\',\'"+password1+"\',\'"+mail+"\',N\'"+address+"\',\'"+phone+"\',\'user\')";
                      try
                      {
                          ...
                          out.print("<br><pre>                              Đăng ký thành công, vào trang đăng nhập tài khoản</pre>");
                          con.close();
                          }
                          else
                          {
                              out.print("<br><pre>                              Tài khoản đã tồn tại</pre>");
                          }
                          con.close();
                      }
                      catch(Exception ex)
